              ...
              <ul className="flex flex-col-reverse space-x-0 lg:space-x-6 lg:flex-row">
                {user ? (
                  <li className="mt-4 lg:mt-0">
                    <span
                      onClick={onLogout}
                      className="py-3 px-4 text-center text-white bg-black  rounded-md shadow block lg:inline cursor-pointer"
                    >
                      Logout
                    </span>
                  </li>
                  ...
                  <>
                    ...
                    <li className="mt-8 lg:mt-0">
                      <a
                        href="/register"
                        className="py-3 px-4 text-center text-white bg-black  rounded-md shadow block lg:inline"
                      >
                        Sign Up
                      </a>
                    </li>
